...
export const chat: PathAttributes = {
...
export const feeds: PathAttributes = {
  ...defaultPathAttributes,
...
export const lists: PathAttributes = {
  ...defaultPathAttributes,
...
export const notifications: PathAttributes = {
  ...defaultPathAttributes,
...
export const profile: PathAttributes = {
  ...defaultPathAttributes,
...
export const settings: PathAttributes = {
  ...defaultPathAttributes,
